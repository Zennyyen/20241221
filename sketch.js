...
function draw() {
  ...
  // Player 1 操作說明
  text("Player 1 控制:", 10, height - 120);
  text("↑ : 跳躍", 10, height - 90);
  text("← → : 移動", 10, height - 60);
  text("Enter : 發射", 10, height - 30);
  
  // Player 2 操作說明
  text("Player 2 控制:", width - 200, height - 120);
  text("W : 跳躍", width - 200, height - 90);
  text("A D : 移動", width - 200, height - 60);
  text("Shift : 發射", width - 200, height - 30);
